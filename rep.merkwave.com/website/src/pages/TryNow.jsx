 ...
 *
 * Collects visitor info + intent, creates a 7-day trial account,
 * and automatically logs the user in — no password step needed.
 */
...
const REASON_OPTIONS = [
  ...
  { value: "Track my sales team performance", label: "Track my sales team performance" },
  { value: "Manage orders and client visits", label: "Manage orders and client visits" },
  { value: "Manage inventory and warehouses", label: "Manage inventory and warehouses" },
  { value: "Monitor sales analytics and reports", label: "Monitor sales analytics and reports" },
  { value: "Evaluate RepWave for my business", label: "Evaluate RepWave for my business" },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (json.status === "success" && json.data) {
        // Auto-login: store session data directly, no separate login step
        localStorage.setItem("userData", JSON.stringify(json.data));
        localStorage.setItem("companyName", DEMO_COMPANY);
        navigate("/");
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">
              Why do you want to try RepWave?{" "}
              <span className="text-gray-400">(optional)</span>
            </label>
            <select
              name="trial_reason"
              value={formData.trial_reason}
              onChange={handleChange}
              className="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent bg-white"
            >
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-green-200 overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg text-xs text-amber-800">
              ...
              recovered. Demo data resets every midnight. Your account expires
              in {result.days} days.
            </div>
