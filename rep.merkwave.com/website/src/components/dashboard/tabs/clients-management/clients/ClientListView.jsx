    ...
    <>
      {!loading && !error && clients.length === 0 && (
        <div className="bg-white rounded-xl shadow border border-gray-200 p-12 text-center animate-fadeIn">
          ...
          <p className="text-gray-500 text-sm mt-2">جرب البحث بكلمات مختلفة أو أضف عميلًا جديدًا</p>
        </div>
      )}
            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <SortableHeader title="الشركة" sortKey="clients_company_name" className="min-w-[160px] border-r border-gray-200" />
                  <SortableHeader title="المندوب المسئول" sortKey="clients_rep_user_id" className="min-w-[120px] border-r border-gray-200" />
                  <SortableHeader title="المنطقة" sortKey="clients_area_tag_id" className="min-w-[100px] border-r border-gray-200" />
                  <SortableHeader title="الصناعة" sortKey="clients_industry_id" className="min-w-[100px] border-r border-gray-200" />
                  <SortableHeader title="الرصيد" sortKey="clients_credit_balance" className="min-w-[80px] border-r border-gray-200" />
                  <SortableHeader title="الحالة" sortKey="clients_status" className="min-w-[70px] border-r border-gray-200" />
