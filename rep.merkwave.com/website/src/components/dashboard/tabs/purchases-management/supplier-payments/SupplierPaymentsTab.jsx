        ...
        <CustomPageHeader
          ...
          actionButton={
            <button
              ...
              className="bg-white text-blue-600 font-bold py-2 px-4 rounded-md shadow-sm border border-gray-200 hover:bg-gray-50 flex items-center gap-2"
            >
              <PlusIcon className="h-5 w-5" /> إضافة دفعة
            </button>
          }
        />
