// src/components/dashboard/tabs/product-management/categories/AddCategoryForm.js
...
function AddCategoryForm({ onAdd, onCancel }) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md max-w-xl mx-auto" dir="rtl">
      <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">إضافة فئة جديدة</h3>
