  ...
  return (
    <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
      <div className="overflow-x-auto">
                  ...
                  <div className="flex items-center gap-2">
                    {safe.safes_type === "company" ? (
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="bg-[#EDE7FF] text-[#2D1B69] text-xs font-medium px-2 py-1 rounded-full">
                          خزنة مندوب
                        </span>
                      </div>
                    )}
        ...
        {filtered.length === 0 && (
          <div className="text-center py-8 text-gray-500">لا توجد خزائن</div>
        )}
      </div>
    </div>
  );
...
export default function SafeManagementTab() {
  ...
  const filteredSafes = useMemo(() => {
    ...
    if (selectedStatusFilter) {
      ...
      currentFiltered = currentFiltered.filter(
        (safe) => safe.safes_is_active === isActive,
      );
    }
      ...
      <>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0">
          <h3 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
            <ArchiveBoxIcon className="h-8 w-8 text-[#8B5FD6]" />
            إدارة الخزائن
          </h3>
          ...
          <div className="bg-gradient-to-r from-[#EDE7FF] to-[#f5f3ff] p-6 rounded-xl border border-[#C4A8F0]">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-[#2D1B69]">
                  {filteredSafes.length}
                </p>
              </div>
              <ArchiveBoxIcon className="h-12 w-12 text-[#8B5FD6]" />
            </div>
          </div>

          <div className="bg-gradient-to-r from-green-100 to-green-50 p-6 rounded-xl border border-[#C4A8F0]">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-800">
                  {
                    filteredSafes.filter((safe) => safe.safes_is_active === 1)
                      .length
                  }
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] focus:border-[#8B5FD6] sm:text-sm"
                dir="rtl"
              >
