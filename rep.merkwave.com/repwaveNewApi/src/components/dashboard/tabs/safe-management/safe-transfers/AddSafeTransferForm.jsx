...
const AddSafeTransferForm = ({ onClose, onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const transferData = {
        from_safe_id: parseInt(formData.source_safe_id),
        to_safe_id: parseInt(formData.destination_safe_id),
        amount: parseFloat(formData.transfer_amount),
        notes: formData.transfer_notes || null,
              ...
              <div className="p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  {destinationSafe && (
                    <p className="mt-1.5 text-xs text-gray-500">
                      الرصيد:{" "}
                      <span className="font-semibold text-[#8B5FD6]">
            ...
            {(sourceSafe || destinationSafe || formData.transfer_amount) && (
              <div className="rounded-xl bg-gradient-to-l from-[#f5f3ff] to-[#f5f3ff] border border-[#EDE7FF] px-4 py-3">
                ...
                <div className="flex items-center gap-2 flex-wrap text-sm">
                  ...
                  {formData.transfer_amount && (
                    <span className="mr-auto font-bold text-[#7A52C2]">
