...
const STATUS_CONFIG = {
  ...
  confirmed: { color: "bg-[#EDE7FF] text-[#2D1B69]", label: "مؤكد" },
    ...
    <tr className="[&>td]:border [&>td]:p-1 hover:bg-gray-50 text-xs text-gray-700">
      ...
      <td className="text-center w-56">
        <select
          ...
          className="w-56 text-xs px-2 py-1 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#8B5FD6] focus:border-[#8B5FD6] disabled:bg-gray-100"
        >
                  ...
                  {deliverableItems.length > 0 && (
                    <div className="ms-auto flex flex-wrap items-center gap-2">
                      <button
                        ...
                        className="border border-gray-300 bg-[#C4A8F0] px-3 py-1 rounded hover:bg-gray-100"
                      >
                        تحديد الأمر بالكامل
                      </button>
                      {selectedCount > 0 && (
                      ...
                      >
                        ...
                        <div className="flex items-start gap-2">
                          <input
                            ...
                            className="h-4 w-4 mt-0.5 text-[#8B5FD6] border-gray-300 rounded flex-shrink-0"
                          />
                        ...
                        {isSelected && (
                          <div className="mt-2 space-y-1.5 border-t border-[#C4A8F0] pt-2">
                            ...
                            <div>
                              ...
                              <select
                                ...
                                className="w-full text-xs px-2 py-1.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#8B5FD6] disabled:bg-gray-100"
                              >
                                <option value="">اختر دفعة</option>
                                {batches.map((b) => (
                                  <option
                  ...
                  <div className="border rounded p-3 bg-gray-50 space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2 text-xs">
                      ...
                      <button
                        ...
                        className="px-4 py-1 rounded bg-[#C4A8F0] text-black disabled:opacity-50 inline-flex items-center gap-2"
                      >
              ...
              <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-2/3 lg:w-1/2 p-3 sm:p-4 max-h-[95vh] overflow-y-auto">
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    ...
                    className="px-4 py-1 bg-[#8B5FD6] text-white rounded"
                  >
                    نعم
                  </button>
                </div>
