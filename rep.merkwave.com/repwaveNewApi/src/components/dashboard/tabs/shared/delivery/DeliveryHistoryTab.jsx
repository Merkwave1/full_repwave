          ...
          <div className="mt-4 sm:mt-20 mx-auto w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 max-h-[95vh] sm:max-h-[85vh] overflow-y-auto rounded-2xl bg-white shadow-2xl border border-gray-100">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-xl bg-[#C4A8F0] text-[#1A0F35] shadow-md">
                  <TruckIcon className="h-6 w-6" />
                </div>
                <h3 className="text-lg font-semibold text-[#1A0F35]">
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="bg-gray-50 rounded-xl px-3 py-2 text-sm font-medium text-[#1A0F35] shadow-inner">
                      ...
                      <div>
                        ...
                        <div className="bg-gray-50 rounded-xl px-3 py-2 text-sm text-[#1A0F35] shadow-inner">
                          {warehouses.find(
                            (w) =>
                              w.warehouse_id ===
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="bg-gray-50 rounded-xl px-3 py-3 min-h-[80px] text-sm text-[#1A0F35] shadow-inner">
                  ...
                  deliveryDetails.items.length > 0 ? (
                    <div className="border-t pt-6">
                      <h4 className="text-lg font-semibold text-[#1A0F35] mb-4">
                          ...
                          <tbody>
                            {deliveryDetails.items.map((item, index) => (
                              ...
                              >
                                ...
                                <td className="py-3 font-medium text-[#1A0F35]">
                                  {item.variant_name ||
                                    item.products_name ||
                                    "غير محدد"}
                                  {item.products_name &&
                                ...
                                <td className="py-3 text-center font-semibold text-[#8B5FD6]">
                                  {parseFloat(
