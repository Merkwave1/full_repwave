    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-5xl max-h-[90vh] flex flex-col detail-modal-print" dir="rtl">
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b bg-gradient-to-r from-indigo-50 to-blue-50 rounded-t-xl print:bg-white print:border-b-0 print:rounded-none">
          <h3 className="font-bold text-gray-800 text-sm md:text-base">{title}: <span className="text-[#8B5FD6]">{client?.clients_company_name}</span></h3>
          <div className="flex items-center gap-2">
            {customHeaderButton || (
              <button onClick={() => window.print()} className="no-print px-3 py-1.5 text-[11px] font-semibold rounded-md bg-[#8B5FD6] hover:bg-[#7A52C2] text-white">طباعة</button>
            )}
