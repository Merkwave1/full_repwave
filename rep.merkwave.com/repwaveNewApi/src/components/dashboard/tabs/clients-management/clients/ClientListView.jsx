                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-gray-900 font-medium border-r border-gray-200">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-9 h-9 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 ${getAvatarColor(client.clients_company_name)}`}
                        >
                          {getInitials(client.clients_company_name)}
                        </div>
                        <div
