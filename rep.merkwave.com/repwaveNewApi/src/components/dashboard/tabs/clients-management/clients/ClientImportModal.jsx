...
const headerMap = {
  ...
  الهاتف: "clients_contact_phone1",
  "هاتف 2": "clients_contact_phone2",
  ...
  phone: "clients_contact_phone1",
  phone1: "clients_contact_phone1",
  phone_1: "clients_contact_phone1",
  phone2: "clients_contact_phone2",
  phone_2: "clients_contact_phone2",
  email: "clients_email",
...
export default function ClientImportModal({ open, onClose, onDone }) {
  ...
  const requiredFields = useMemo(
    () => ["clients_company_name", "clients_contact_phone1"],
    [],
  );
    ...
    >
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-500">
            ...
            {CLIENT_STATUS_OPTIONS.map((option) => option.label).join("، ")}
          </p>
          {parsing && (
            <div className="text-sm text-gray-500">جاري قراءة الملف...</div>
          )}
          {rows.length > 0 && (
                    ...
                    {rows.slice(0, 20).map((r, i) => (
                      <tr key={i} className="odd:bg-white even:bg-gray-50">
                        <td className="px-3 py-2">
                          {r.clients_company_name || "—"}
                        </td>
                        <td className="px-3 py-2">
                          {r.clients_contact_phone1 || "—"}
                        </td>
                        ...
                        <td className="px-3 py-2">
                          {(() => {
                            ...
                            return normalizedStatus
                              ? getClientStatusLabel(normalizedStatus)
                              : "—";
                          })()}
                        </td>
          ...
          {progress.total > 0 && (
            <div className="text-sm">
              <div className="mb-1">
                تم الاستيراد: {progress.done} / {progress.total}
              </div>
