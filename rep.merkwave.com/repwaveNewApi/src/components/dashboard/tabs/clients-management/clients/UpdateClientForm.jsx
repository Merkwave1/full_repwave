...
function UpdateClientForm({
  ...
  useEffect(() => {
    ...
    if (client) {
      setFormData({
        ...
        clients_contact_phone1: client.clients_contact_phone1 || "",
        clients_contact_phone2: client.clients_contact_phone2 || "",
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      !formData.clients_contact_phone1
    ) {
      setFormError(
  ...
  const premiumInput =
    "block w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md focus:outline-none focus:border-[#C4A8F0] focus:ring-4 focus:ring-[#C4A8F0]/30 transition-all duration-300";

  const premiumInputSmall =
    "block w-full px-3 py-2 rounded-xl border border-gray-200 bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md focus:outline-none focus:border-[#C4A8F0] focus:ring-4 focus:ring-[#C4A8F0]/30 transition-all duration-300 text-sm";

  const premiumLabel =
    "block text-sm font-semibold text-[#1A0F35] mb-1 tracking-wide";
  ...
  const renderTabContent = () => {
    switch (activeTab) {
          ...
          <div className={premiumCard}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 flex flex-col items-center gap-3 py-4">
                ...
                >
                  <div className="w-40 h-40 rounded-full overflow-hidden bg-gradient-to-br from-[#C4A8F0]/40 to-white border border-white/60 shadow-[0_12px_40px_-10px_rgba(141,216,245,0.9)] hover:shadow-[0_18px_60px_-10px_rgba(141,216,245,1)] transition-all duration-500 flex items-center justify-center group-hover:scale-105">
                    {previewUrl ? (
                      <img
                        src={previewUrl}
                        alt="صورة العميل"
      ...
      focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] focus:border-[#8B5FD6]
