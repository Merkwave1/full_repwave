...
const DetailItem = ({
  ...
  >
    ...
    <div className="flex flex-col flex-1 min-w-0">
      <span className="text-xs font-semibold uppercase tracking-wide text-[#1A0F35]/60">
        {label}
      </span>
      <span
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-t-xl">
        <div className="absolute inset-0 bg-gradient-to-l from-[#1A0F35] to-[#2D1B69]" />
        <div className="absolute inset-0 bg-[#C4A8F0] opacity-10" />

        <div className="relative p-4 sm:p-6 flex items-start justify-between">
          <div className="flex flex-col gap-1.5 sm:gap-2">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="p-2 sm:p-3 bg-[#C4A8F0]/20 rounded-xl backdrop-blur">
                <Bars3BottomLeftIcon className="h-5 w-5 sm:h-7 sm:w-7 text-[#C4A8F0]" />
              </div>
            ...
            <p className="text-sm text-[#C4A8F0]/80">تفاصيل وبيانات المورد</p>
          </div>
      ...
      <div className="flex flex-col lg:flex-row flex-grow min-h-0 overflow-hidden bg-gray-50">
        ...
        <aside className="lg:w-64 w-full border-b lg:border-b-0 lg:border-l border-gray-200 bg-white p-3 sm:p-4 flex-shrink-0 overflow-y-auto">
          <h4 className="text-sm font-bold text-[#1A0F35] mb-4">ملخص سريع</h4>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-1 gap-3">
            {stats.map((s) => (
              <div
                ...
                p-4 rounded-xl
                bg-[#C4A8F0]/10
                border border-[#C4A8F0]/20
                hover:shadow-sm
                transition
              "
              >
                <div className="flex items-center gap-2 mb-1 text-xs font-semibold text-[#1A0F35]">
                  {React.cloneElement(s.icon, {
                    className: "h-4 w-4 text-[#C4A8F0]",
                  })}
                  {s.label}
                </div>
                <div className="text-sm font-bold text-[#1A0F35] break-words">
                  {s.value ?? "—"}
                </div>
              </div>
            ))}
        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 mb-4 sm:mb-10">
            <div className="space-y-5">
              <h5 className="text-sm font-extrabold tracking-wide text-[#1A0F35]/60 uppercase flex items-center gap-2">
                <InformationCircleIcon className="h-5 w-5 text-[#C4A8F0]" />
                بيانات أساسية
              </h5>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 shadow-sm">
            <h5 className="text-sm font-extrabold tracking-wide text-[#1A0F35]/60 uppercase mb-4 flex items-center gap-2">
              <ClipboardDocumentListIcon className="h-5 w-5 text-[#C4A8F0]" />
              نشاط
            </h5>
          </div>
        </div>
