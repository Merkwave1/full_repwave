...
function ClientAssignmentsTab() {
  ...
  const filteredClients = useMemo(() => {
    ...
    return availableClients.filter((client) => {
      ...
      const phone1 = client.clients_contact_phone1 || "";
      const phone2 = client.clients_contact_phone2 || "";
      ...
      },
      {
        ...
        render: (client) => (
          <div className="space-y-1">
            <div className="font-semibold text-[#2D1B69] leading-snug">
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      ...
      <div className="bg-[#f5f3ff] border border-[#C4A8F0] rounded-lg p-4 leading-loose text-sm text-[#2D1B69]">
