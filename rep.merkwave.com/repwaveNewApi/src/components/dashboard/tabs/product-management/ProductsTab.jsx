        ...
        if (selectedCategoryFilter)
          activeChips.push({
            ...
            value:
              categories.find(
                (c) =>
                  String(c.categories_id) === String(selectedCategoryFilter),
            ...
            <CustomPageHeader
              ...
              actionButton={
                <button
                  ...
                  className="px-3 py-2 bg-white text-[#8B5FD6] rounded-md font-semibold"
                >
                  إضافة منتج
                </button>
              }
