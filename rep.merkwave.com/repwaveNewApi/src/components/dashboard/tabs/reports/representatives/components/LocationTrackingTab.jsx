  ...
  return (
    <div className="p-3 sm:p-6">
      ...
      <CustomPageHeader
        ...
        icon={<MapPinIcon className="h-8 w-8 text-[#1A0F35]" />}
      ...
      {!loading && locationData.length > 0 && (
        <div className="mb-4 flex justify-end">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#8B5FD6] text-white rounded-lg hover:bg-[#7A52C2] transition-colors shadow-md font-medium"
          >
        ...
        <Modal
          ...
          actions={
            <button
              ...
              className="px-5 py-2.5 bg-white hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed text-[#8B5FD6] disabled:text-gray-400 rounded-lg transition-colors font-bold flex items-center gap-2 shadow-sm border-2 border-white/20"
        ...
        >
          <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6">
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-[#EDE7FF] rounded-lg">
                    <UserIcon className="h-5 w-5 text-[#8B5FD6]" />
                  </div>
                  <div className="flex-1">
                    <div className="text-xs text-[#8B5FD6] font-medium mb-1">
                      المندوب
                    </div>
            ...
            {selectedDateTab === "custom" && (
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 sm:items-end bg-[#f5f3ff] p-3 sm:p-4 rounded-lg">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8B5FD6]"
                  />
                </div>
                <div className="flex-1">
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 bg-[#8B5FD6] text-white rounded-lg hover:bg-[#7A52C2] transition-colors"
                >
                  بحث
                </button>
              </div>
                      ...
                      <tr key={item.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-center">
                          <button
                            ...
                            className="text-[#8B5FD6] hover:text-[#2D1B69] text-sm font-medium"
                          >
      ...
      {showWorkdayModal && selectedRep && (
        ...
        >
          <div className="p-4">
            {loadingWorkdays ? (
              <div className="flex justify-center py-8">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#8B5FD6]"></div>
              </div>
                ...
                {workdayList.map((workday) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full p-3 text-right bg-white hover:bg-[#f5f3ff] border border-gray-200 rounded-lg transition-colors"
                    >
