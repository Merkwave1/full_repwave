  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <p className="text-3xl font-bold text-[#8B5FD6] mb-2">{overview.active_products?.toLocaleString() || 0}</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <p className="text-3xl font-bold text-[#8B5FD6] mb-2">{overview.new_this_month?.toLocaleString() || 0}</p>
        <p className="text-gray-600 text-sm">
