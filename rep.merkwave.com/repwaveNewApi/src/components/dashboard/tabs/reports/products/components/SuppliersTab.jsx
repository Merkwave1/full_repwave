              ...
              return (
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-3 sm:mb-4 gap-2">
                    ...
                    {/* Rank Badge */}
                    <span className="text-xs font-semibold bg-[#f5f3ff] text-[#8B5FD6] px-2 sm:px-3 py-1 rounded-full shrink-0">
                      #{index + 1}
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-3 sm:mb-5">
                    <div className="bg-[#f5f3ff] rounded-xl p-2 sm:p-3 text-center">
                      <p className="text-base sm:text-lg font-semibold text-[#8B5FD6]">
