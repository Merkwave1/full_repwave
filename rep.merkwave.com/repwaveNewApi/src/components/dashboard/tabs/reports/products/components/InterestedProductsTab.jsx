...
const InterestedProductsTab = ({ data, loading }) => {
  ...
  const productColumns = useMemo(() => ([
      ...
      render: (item) => (
        ...
        <div className="flex items-center gap-3 flex-row-reverse justify-end" dir="rtl">
          ...
          {item.products_image_url ? (
            ...
            <div className="w-6 h-6 rounded-lg bg-[#EDE7FF] text-[#8B5FD6] flex items-center justify-center text-sm font-semibold">
    ...
    },
    {
      ...
      sortable: true,
      render: (item) => (
        <span className="text-base font-bold text-[#8B5FD6]">
  ...
  const clientColumns = useMemo(() => ([
    ...
    },
    {
      ...
      title: 'الهاتف',
      align: 'center',
      render: (item) => item.clients_contact_phone1 || '—',
    },
    {
      key: 'clients_city',
      title: 'المدينة',
  ...
  return (
    <div className="space-y-6" dir="rtl">
      <CustomPageHeader
        ...
        icon={<UserGroupIcon className="h-8 w-8 text-[#1A0F35]" />}
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-4">
                {productMeta.products_image_url ? (
                  ...
                  <div className="w-16 h-16 rounded-lg bg-[#EDE7FF] text-[#8B5FD6] flex items-center justify-center text-xl font-semibold">
              ...
              <div className="text-sm text-gray-600">
                إجمالي العملاء المهتمين: <span className="font-bold text-[#8B5FD6]">{formatNumber(clients.length)}</span>
              </div>
            </div>
          )}
