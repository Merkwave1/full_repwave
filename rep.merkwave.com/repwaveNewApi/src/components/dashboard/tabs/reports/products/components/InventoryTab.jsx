          ...
          {inventory.warehouses?.map((warehouse) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs px-3 py-1 rounded-full bg-[#f5f3ff] text-[#8B5FD6] font-medium">
                  Warehouse
                </span>
              </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-[#f5f3ff] rounded-lg p-3 text-center">
                    <p className="text-xs text-[#8B5FD6]">المخازن</p>
                    <p className="font-semibold text-[#7A52C2]">
                ...
                {inventory.top_products.map((product, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <span className="px-3 py-1 rounded-lg bg-[#f5f3ff] text-[#8B5FD6] text-sm font-medium">
                        {product.warehouse_count}
                      </span>
                    </td>
                  </tr>
