      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-[#f5f3ff] rounded-lg">
            <p className="text-2xl font-bold text-[#8B5FD6]">{categories.total_categories || 0}</p>
          ...
          {categories.categories.map((category, index) => (
            ...
            >
              ...
              <div className="w-full bg-gray-100 rounded-full h-2.5 mb-5 overflow-hidden">
                <div
                  className="bg-[#8B5FD6] h-2.5 rounded-full transition-all duration-500"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-[#f5f3ff] rounded-xl p-3 text-center">
                  <p className="text-lg font-semibold text-[#8B5FD6]">
