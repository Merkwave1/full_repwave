        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-[#f5f3ff] rounded-lg">
              <p className="text-xl font-bold text-[#8B5FD6]">{analytics.inventory_analysis.total_inventory_units?.toLocaleString() || 0}</p>
              ...
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex items-center space-x-3 space-x-reverse">
                  <div className="w-24 bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-[#8B5FD6] h-2 rounded-full" 
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-5 border rounded-xl hover:shadow-sm transition-shadow">
              <p className="text-2xl font-extrabold text-[#8B5FD6]">{analytics.growth_analysis.this_month?.toLocaleString() || 0}</p>
            ...
            <div className="text-center p-5 border rounded-xl hover:shadow-sm transition-shadow">
              <div className="flex items-center justify-center mb-2">
                ...
                <p className={`text-2xl font-extrabold ${analytics.growth_analysis.growth_rate > 0 ? 'text-green-600' : analytics.growth_analysis.growth_rate < 0 ? 'text-red-600' : 'text-[#8B5FD6]'}`}>
