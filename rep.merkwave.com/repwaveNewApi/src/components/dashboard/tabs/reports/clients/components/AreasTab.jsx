    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 text-center">
          ...
          <p className="text-2xl font-bold text-[#8B5FD6] mb-2">{areas.total_areas?.toLocaleString() || 0}</p>
            ...
            {areas.top_cities.map((city, index) => (
              <div key={index} className="p-4 bg-gray-50 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#8B5FD6]">{city.client_count?.toLocaleString() || 0}</span>
                </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <p className="text-xl font-bold text-[#8B5FD6]">{areas.clients_with_areas?.toLocaleString() || 0}</p>
          ...
          <div className="text-center">
            <p className="text-xl font-bold text-[#8B5FD6]">{areas.clients_without_areas?.toLocaleString() || 0}</p>
