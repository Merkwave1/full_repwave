    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
        <div className="bg-white rounded-lg shadow-sm border p-6 text-center">
          ...
          <p className="text-2xl font-bold text-[#8B5FD6] mb-2">{formatNumber(analytics.total_clients)}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 border rounded-lg">
              <div className="flex items-center justify-center mb-2">
                ...
                <p className="text-xl font-bold text-[#8B5FD6]">
      ...
      {analytics.credit_analysis && (
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <p className="text-xl font-bold text-[#8B5FD6]">{formatNumber(analytics.credit_analysis.avg_credit_limit)}</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-[#f5f3ff] rounded-lg">
              <p className="text-xl font-bold text-[#8B5FD6]">{formatNumber(analytics.profile_completeness.with_phone)}</p>
