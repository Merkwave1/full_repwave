    ...
    <div className="space-y-6">
            ...
            {industries.industry_distribution.map((industry, index) => (
              <div key={index} className="p-4 bg-gray-50 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#8B5FD6]">{industry.client_count?.toLocaleString() || 0}</span>
                </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            <p className="text-xl font-bold text-[#8B5FD6]">{industries.most_popular_industry || 'غير محدد'}</p>
