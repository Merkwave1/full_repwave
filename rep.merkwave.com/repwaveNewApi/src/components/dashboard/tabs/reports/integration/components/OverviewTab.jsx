    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white rounded-lg border border-gray-200 p-5 shadow-sm">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="text-center p-3 bg-[#f5f3ff] rounded-lg">
              <div className="text-2xl font-bold text-[#8B5FD6]">{todayTotal}</div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5 shadow-sm">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="text-center p-3 bg-[#f5f3ff] rounded-lg">
              <div className="text-2xl font-bold text-[#8B5FD6]">{monthTotal}</div>
              <div className="text-xs text-gray-500">إجمالي</div>
            </div>
            <div className="text-center p-3 bg-green-50 rounded-lg">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
          <ChartBarIcon className="h-5 w-5 text-[#8B5FD6]" />
          إحصائيات عامة (الكل)
        </h3>
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
          <UserGroupIcon className="h-5 w-5 text-[#8B5FD6]" />
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
          <CubeIcon className="h-5 w-5 text-[#8B5FD6]" />
