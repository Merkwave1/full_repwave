            ...
            return (
              ...
              >
                ...
                {tabItem.key === 'contacts' && contactsStats?.total > 0 && (
                  <span className="bg-indigo-100 text-[#8B5FD6] text-xs px-2 py-0.5 rounded-full mr-2">
                    {contactsStats.total}
                  </span>
                )}
                {tabItem.key === 'products' && productsStats?.total_syncs > 0 && (
                  <span className="bg-teal-100 text-[#8B5FD6] text-xs px-2 py-0.5 rounded-full mr-2">
