        ...
        <div className="flex items-center justify-between px-4 py-3 sm:px-8 sm:py-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          ...
          <div className="flex items-center space-x-2 rtl:space-x-reverse">
            {formattedOrderData?.purchase_order_status === "Draft" && (
              <button
                onClick={handleEdit}
                className="p-2 text-[#8B5FD6] hover:bg-[#f5f3ff] rounded-lg transition-all duration-200 hover:scale-105"
                title="تعديل"
              >
                <FaEdit size={18} />
              </button>
        ...
        <div className="overflow-y-auto max-h-[calc(95vh-120px)] sm:max-h-[calc(92vh-200px)]">
          {loading && (
            <div className="flex items-center justify-center py-16">
              <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-[#8B5FD6]"></div>
            </div>
          )}
