        ...
        >
                      ...
                      <div>
                        ...
                        {(item.available_to_return_received > 0 ||
                          ...
                          <div className="flex items-center gap-4 text-xs mt-1">
                            ...
                            {item.available_to_return_received > 0 && (
                              <div className="text-[#8B5FD6] font-medium">
          ...
          <div className="flex items-center justify-end space-x-4 space-x-reverse pt-6 border-t">
            <button
              type="button"
              onClick={onCancel}
              className="px-6 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B5FD6]"
            >
              إلغاء
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#8B5FD6] hover:bg-[#7A52C2] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B5FD6] disabled:opacity-50"
            >
