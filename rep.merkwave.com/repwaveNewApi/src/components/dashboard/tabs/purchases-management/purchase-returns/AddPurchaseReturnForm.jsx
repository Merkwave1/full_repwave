  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
        <div className="bg-gradient-to-r from-[#f5f3ff] to-[#E8DFFF] px-6 py-4 border-b border-gray-300">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] focus:border-[#8B5FD6]"
                dir="rtl"
              ...
              {formData.purchase_order_id && selectedOrderDetails && (
                <div className="mt-2 p-2 bg-[#f5f3ff] rounded text-sm">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                type="button"
                onClick={addItem}
                className="bg-[#8B5FD6] hover:bg-[#7A52C2] text-white px-4 py-2 rounded-md shadow-sm flex items-center gap-2"
                          ...
                          <div className="mt-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200 overflow-hidden">
                            ...
                            <div className="p-4">
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {/* المطلوب */}
                                <div className="text-center bg-[#f5f3ff] rounded-lg p-3 border border-[#C4A8F0]">
                                  <div className="text-xs text-[#8B5FD6] font-medium mb-1">المطلوب</div>
                                ...
                                {/* المستلم */}
                                <div className="text-center bg-green-50 rounded-lg p-3 border border-[#C4A8F0]">
          ...
          {formData.items.length > 0 && totalAmount > 0 && (
            <div className="bg-gradient-to-r from-[#f5f3ff] to-[#EDE7FF] p-6 rounded-lg border border-[#C4A8F0] shadow-sm">
              <div className="mb-3">
          ...
          <div className="flex items-center justify-end space-x-4 space-x-reverse pt-6 border-t">
            <button
              type="button"
              onClick={onCancel}
              className="px-6 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#8B5FD6]"
            >
              إلغاء
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 bg-[#8B5FD6] text-white rounded-md hover:bg-[#7A52C2] focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] disabled:opacity-50 disabled:cursor-not-allowed"
            >
