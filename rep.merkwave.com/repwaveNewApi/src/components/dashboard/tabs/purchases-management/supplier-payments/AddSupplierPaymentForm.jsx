  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const paymentData = {
        ...
        safe_id: formData.safe_id ? parseInt(formData.safe_id) : null,
        payment_method_id: 1, // Default payment method (cash)
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {formData.supplier_id && selectedSupplierBalance !== null && (
                  <div className="mt-2 p-2 bg-[#f5f3ff] rounded border border-[#C4A8F0]">
                    <p className="text-xs text-gray-600">
                      رصيد المورد:{" "}
                      <span
                        className={`font-semibold ${selectedSupplierBalance > 0 ? "text-[#8B5FD6]" : selectedSupplierBalance < 0 ? "text-red-600" : "text-gray-600"}`}
                      >
              ...
              <div>
                ...
                {formData.safe_id && selectedSafeBalance !== null && (
                  <div className="mt-2 p-2 bg-green-50 rounded border border-[#C4A8F0]">
                    <p className="text-xs text-gray-600">
                      رصيد الخزنة:{" "}
                      <span
