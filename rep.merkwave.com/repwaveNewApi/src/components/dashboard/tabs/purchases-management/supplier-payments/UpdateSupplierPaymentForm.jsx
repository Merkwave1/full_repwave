        ...
        <div className="bg-gradient-to-r from-[#f5f3ff] to-[#E8DFFF] px-4 py-3 sm:px-6 sm:py-4 border-b border-gray-300">
          <div className="flex items-center justify-between">
            <h3 className="text-base sm:text-xl font-bold text-gray-800 flex items-center gap-2 truncate">
              <PencilIcon className="h-6 w-6 text-[#8B5FD6]" />
        ...
        <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:py-4 border-t border-gray-200">
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto px-4 py-3 sm:px-6 sm:py-2 bg-[#8B5FD6] text-white rounded-md hover:bg-[#7A52C2] focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-base sm:text-sm"
            >
              {isSubmitting && (
                <svg
