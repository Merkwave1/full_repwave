  ...
  return (
    <div className="p-4" dir="rtl">
      ...
      <CustomPageHeader
        ...
        icon={<InboxArrowDownIcon className="h-8 w-8 text-[#1A0F35]" />}
                ...
                {selectableItems.length > 0 && (
                  <div className="flex flex-wrap items-center gap-2">
                    <button
                      ...
                      className="border border-gray-300 bg-[#C4A8F0] px-3 py-1 rounded hover:bg-gray-100 text-xs"
                    >
                      تحديد الأمر بالكامل
                    </button>
                  ...
                  {order.items.map((item) => {
                    ...
                    return (
                      <div
                        ...
                        className={`border rounded-lg p-3 text-xs space-y-2 ${isReceiving ? "border-[#C4A8F0] bg-[#f5f3ff]" : "bg-gray-50"} ${remainingQuantity <= 0 ? "opacity-60" : ""}`}
                      >
                        ...
                        <div className="grid grid-cols-3 gap-1 text-center">
                          ...
                          <div className="bg-white rounded p-1 border">
                            ...
                            <div className="font-semibold text-[#7A52C2]">
                ...
                <div className="border rounded p-3 bg-gray-50 space-y-2">
                  ...
                  <div className="flex flex-wrap items-center gap-2 text-xs">
                    ...
                    <button
                      ...
                      className="flex-1 sm:flex-none px-4 py-1.5 rounded bg-[#C4A8F0] text-black disabled:opacity-50 text-center"
                    >
          ...
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-2/3 lg:w-1/2 p-3 sm:p-4 max-h-[95vh] overflow-y-auto">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-1 bg-[#1A0F35] text-white rounded"
              >
                نعم
              </button>
            </div>
