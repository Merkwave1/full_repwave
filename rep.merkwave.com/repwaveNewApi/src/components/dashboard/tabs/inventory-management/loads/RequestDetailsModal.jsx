        ...
        <div className="bg-white rounded-2xl p-4 border">
          ...
          <div className="sm:hidden flex flex-col gap-3">
            {items.map((it) => (
              ...
              >
                {/* Product name */}
                <div className="font-semibold text-sm text-[#1A0F35]">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full appearance-none rounded-lg px-3 py-2 pr-8 bg-white border border-gray-200 text-xs font-medium text-[#1A0F35] focus:outline-none focus:ring-2 focus:ring-[#C4A8F0]/60"
                      >
                ...
                <div className="flex items-center gap-2 pt-1 border-t">
                  {editRow === it.request_item_id ? (
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 text-xs text-[#7A52C2] bg-[#f5f3ff] px-2 py-1 rounded-lg"
                    >
                  ...
                  <tr key={it.request_item_id}>
                    ...
                    <td className="px-4 py-2 text-center flex items-center gap-2 justify-center">
                      {editRow === it.request_item_id ? (
                        ...
                        <button
                          className="text-[#8B5FD6] hover:text-[#2D1B69]"
                          title="تعديل"
                          onClick={() => setEditRow(it.request_item_id)}
                        >
            ...
            <div className="grid grid-cols-1 sm:flex sm:gap-3 sm:items-end gap-3">
              ...
              <div className="flex-shrink-0">
                ...
                <button
                  ...
                  className="w-10 h-10 flex items-center justify-center bg-[#1A0F35] text-white rounded-xl hover:scale-105 transition shadow-md"
                >
