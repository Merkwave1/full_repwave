        ...
        {data.variants.map((variant) => (
          ...
          >
            <div className="px-3 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-[#f5f3ff] to-[#f5f3ff] border-b rounded-t-2xl flex flex-wrap justify-between items-center gap-2">
              ...
              <div className="text-sm font-bold text-[#7A52C2]">
                إجمالي:{" "}
            ...
            <div className="p-5 space-y-6">
              {variant.dateBlocks.map((block) => (
                <div key={block.date} className="bg-gray-50 rounded-xl p-4">
                  <div className="text-xs font-bold text-[#7A52C2] mb-3">
                  ...
                  <div className="overflow-x-auto">
                      ...
                      {block.rows.map((r) => (
                        ...
                        >
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-xs font-bold text-[#7A52C2]">
                          ...
                          <div className="flex gap-2 pt-1">
                            <button
                              className="flex-1 px-2 py-1.5 text-xs rounded-lg bg-[#C4A8F0] text-black hover:text-white hover:bg-[#8B5FD6] shadow-sm transition disabled:opacity-50"
                              onClick={() => {
                    ...
                    <table className="hidden sm:table min-w-full text-[13px] text-gray-700 border-separate border-spacing-y-2">
                      ...
                      <tbody>
                        {block.rows.map((r) => (
                          <tr
                            key={`desktop-row-${r.id}`}
                            className="bg-white hover:bg-[#f5f3ff] transition rounded-xl shadow-sm"
                          >
                            ...
                            <td className="px-3 py-3 font-bold text-[#7A52C2] text-center whitespace-nowrap">
                              {r.totalBase.toLocaleString("en-US", {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2,
                              })}
                            ...
                            <td className="px-3 py-3 text-center">
                              <div className="flex items-center justify-center gap-2">
                                <button
                                  className="px-3 py-1 text-xs rounded-lg bg-[#C4A8F0]  text-black hover:text-white hover:bg-[#8B5FD6] shadow-md hover:shadow-md transition disabled:opacity-50"
                                  onClick={() => {
                                    const preferred = Array.isArray(
                                      product?.preferred_packaging,
                                    )
