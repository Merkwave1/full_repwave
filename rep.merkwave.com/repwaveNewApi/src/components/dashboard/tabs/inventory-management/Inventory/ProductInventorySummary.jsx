  ...
  const columns = [
    {
      ...
      render: (item) => {
        ...
        return (
          <span className="bg-[#1A0F35] text-[#C4A8F0] text-xs px-2 py-1 rounded-full font-semibold">{variantId.toLocaleString('en-US')}</span>
        );
      },
    },
    {
    ...
    },
    {
      ...
      render: (item) => (
        <button
          ...
          className="
            text-[#1A0F35] font-semibold text-xs
            px-3 py-1 rounded-full
            border border-[#C4A8F0]
