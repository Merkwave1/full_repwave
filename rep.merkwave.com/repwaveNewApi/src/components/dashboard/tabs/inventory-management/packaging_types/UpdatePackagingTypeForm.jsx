...
function UpdatePackagingTypeForm({
  ...
  return (
    <div
      className="
      bg-white
      postion absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
      p-4 sm:p-6 md:p-10
    ...
    "
      dir="rtl"
    >
      <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-[#1A0F35] mb-5 sm:mb-8 text-center tracking-wide">
        تعديل نوع التعبئة
      </h3>
