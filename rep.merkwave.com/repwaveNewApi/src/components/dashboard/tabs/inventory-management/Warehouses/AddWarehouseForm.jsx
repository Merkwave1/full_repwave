    ...
    <div className="bg-white p-6 rounded-lg shadow-md max-w-2xl mx-auto" dir="rtl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input type="text" id="warehouse_name" name="warehouse_name" value={formData.warehouse_name} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#8B5FD6] focus:border-[#8B5FD6] sm:text-sm" />
        </div>
        <div>
          <label htmlFor="warehouse_type" className="block text-sm font-medium text-gray-700">نوع المخزن</label>
          <select id="warehouse_type" name="warehouse_type" value={formData.warehouse_type} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#8B5FD6] focus:border-[#8B5FD6] sm:text-sm">
        ...
        <div>
          ...
          <input type="text" id="warehouse_address" name="warehouse_address" value={formData.warehouse_address} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#8B5FD6] focus:border-[#8B5FD6] sm:text-sm" />
        </div>
        ...
        <div>
          ...
          <input type="text" id="warehouse_contact_person" name="warehouse_contact_person" value={formData.warehouse_contact_person} onChange={handleChange} placeholder="اسم أو منصب جهة الاتصال" required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#8B5FD6] focus:border-[#8B5FD6] sm:text-sm" />
        </div>
        <div>
          ...
          <input type="text" id="warehouse_phone" name="warehouse_phone" value={formData.warehouse_phone} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#8B5FD6] focus:border-[#8B5FD6] sm:text-sm" />
        </div>
        <div>
          <label htmlFor="warehouse_status" className="block text-sm font-medium text-gray-700">حالة المخزن</label>
          <select id="warehouse_status" name="warehouse_status" value={formData.warehouse_status} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#8B5FD6] focus:border-[#8B5FD6] sm:text-sm">
        ...
        <div className="flex justify-end space-x-4 space-x-reverse mt-6">
          <button type="button" onClick={onCancel} className="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B5FD6] transition duration-150 ease-in-out">إلغاء</button>
          <button type="submit" className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#8B5FD6] hover:bg-[#7A52C2] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B5FD6] transition duration-150 ease-in-out">إضافة مخزن</button>
        </div>
      </form>
    </div>
  );
