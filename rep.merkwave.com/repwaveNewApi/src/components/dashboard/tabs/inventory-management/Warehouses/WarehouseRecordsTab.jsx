    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <InboxArrowDownIcon className="h-8 w-8 text-[#8B5FD6]" />
          <h2 className="text-2xl font-bold text-gray-800">سجلات الاستلام</h2>
        </div>
        <div className="flex gap-2">
          <button
            onClick={onRefresh}
            className="flex items-center gap-2 px-4 py-2 bg-[#8B5FD6] text-white rounded-lg hover:bg-[#7A52C2] transition-colors"
          >
