      ...
      <div className="flex flex-wrap gap-3 mb-4">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full pr-9 pl-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8B5FD6] focus:outline-none"
          />
          {searchTerm && (
            <button
        ...
        <select
          ...
          className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8B5FD6] focus:outline-none"
        >
                    ...
                    <tr key={req.request_id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-center">
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-[#8B5FD6] hover:text-[#2D1B69] text-xs font-medium"
                        >
