        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              onClick={selectAll}
              disabled={isProcessing}
              className="text-sm text-[#8B5FD6] hover:text-[#2D1B69] disabled:opacity-50"
            >
              تحديد المتاح
            </button>
              ...
              >
                ...
                <div className="absolute top-2 right-2">
                  <input
                    ...
                    className={`w-4 h-4 rounded border-gray-300 focus:ring-[#8B5FD6] ${isDisabled ? "text-gray-400" : activeTab === "delete" ? "text-red-600" : "text-[#8B5FD6]"}`}
                  />
                </div>
