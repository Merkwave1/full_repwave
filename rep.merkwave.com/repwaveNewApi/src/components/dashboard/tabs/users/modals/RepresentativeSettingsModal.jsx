...
function RepresentativeSettingsModal({ isOpen, onClose, user }) {
  ...
  useEffect(() => {
    if (isOpen) {
      loadSettings();
      // Reset to first relevant tab when modal opens
      const firstTab =
            ...
            {loading ? (
              ...
              <div className="space-y-6">
                ...
                {(() => {
                  ...
                  // Warehouses tab visible for ALL roles
                  tabs.push({
                    key: "warehouses",
                    label: "المخازن",
                ...
                {/* Warehouse Selection Section - All roles */}
                {activeTab === "warehouses" && (
                  <div className="p-4 bg-[#C4A8F0]/10 rounded-2xl border border-[#C4A8F0]/30 shadow-sm">
                    <div className="flex items-center gap-3 mb-4">
                      <BuildingStorefrontIcon className="h-6 w-6 text-[#C4A8F0]" />
                      <div>
                        <h4 className="text-lg font-semibold text-[#1A0F35]">
                          المخازن المتاحة
                        </h4>
                        <p className="text-xs text-[#1A0F35]/60 mt-0.5">
                    ...
                    {warehousesLoading ? (
                      ...
                      <p className="text-center text-[#1A0F35]/60 py-4">
                        لا توجد مخازن متاحة
                      </p>
                    ) : (
                              ...
                              <label
                                ...
                                className={`flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition-all ${
                                  selectedWarehouseIds.includes(
                                    ...
                                    ? isMainWarehouse
                                      ? "border-[#C4A8F0] bg-[#C4A8F0]/20"
                                      : "border-[#C4A8F0]/20 bg-white"
                                    : isMainWarehouse
                                      ? "border-[#C4A8F0]/20 bg-white hover:border-[#C4A8F0]/40"
                                      : "border-gray-200 bg-white hover:border-[#C4A8F0]/30"
                                }`}
                              >
                                <input
                                  type="checkbox"
                                ...
                                <div className="flex-1">
                                  <p className="font-semibold text-[#1A0F35] flex items-center gap-2">
                                    {warehouse.warehouse_name}
                                    {isMainWarehouse && (
                                      <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-[#C4A8F0] text-[#1A0F35]">
                                        رئيسي
                                      </span>
                                    )}
                                  </p>
                                  <p className="text-xs text-[#1A0F35]/60">
                                    {warehouseTypeLabel} •{" "}
                    ...
                    <div className="mt-3 text-sm text-[#1A0F35]/70">
                ...
                {activeTab === "safes" && user?.users_role === "cash" && (
                  <div className="p-4 bg-[#C4A8F0]/10 rounded-2xl border border-[#C4A8F0]/30 shadow-sm">
                    <div className="flex items-center gap-3 mb-4">
                      <WalletIcon className="h-6 w-6 text-[#C4A8F0]" />
                      <div>
                        <h4 className="text-lg font-semibold text-[#1A0F35]">
                          الخزن المتاحة
                        </h4>
                    ...
                    <div className="flex items-center justify-between mb-4 p-4 bg-[#C4A8F0]/10 rounded-2xl border border-[#C4A8F0]/30 pb-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#1A0F35]/50 mt-1">
                    ...
                    <div className="flex items-center justify-between mb-4 p-4 bg-[#C4A8F0]/10 rounded-2xl border border-[#C4A8F0]/30 pb-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#1A0F35]/50 mt-1">
                            ⚠️ إلغاء التفعيل يسمح للمندوب بإنهاء العمل من أي
                            مكان
                          </p>
                        </div>
                      </div>
                ...
                {activeTab === "permissions" &&
                  ...
                  user?.users_role !== "cash" && (
                    <div className="space-y-4">
                      ...
                      {user?.users_role !== "store_keeper" &&
                        user?.users_role !== "cash" && (
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 bg-[#C4A8F0]/10 rounded-2xl border border-[#C4A8F0]/30">
                            {/* Left Content */}
                            <div className="flex items-start sm:items-center gap-3">
                              <SignalIcon className="h-5 w-5 text-[#C4A8F0] mt-1 sm:mt-0" />

                              <div>
                                <h4 className="text-base sm:text-lg font-semibold text-[#1A0F35]">
                                  تفعيل تتبع GPS
                                </h4>
                                <p className="text-xs text-[#1A0F35]/60 mt-0.5">
                ...
                {activeTab === "gps" &&
                  ...
                  user?.users_role !== "cash" && (
                    <div className="space-y-4">
                      {/* GPS Accuracy */}
                      <div className="p-4 bg-[#C4A8F0]/10 rounded-2xl border border-[#C4A8F0]/30 pb-6">
                        <div className="flex items-center gap-3 mb-4">
                          <SignalIcon className="h-5 w-5 text-[#C4A8F0]" />
                          <div>
                            <h4 className="text-lg font-semibold text-[#1A0F35]">
