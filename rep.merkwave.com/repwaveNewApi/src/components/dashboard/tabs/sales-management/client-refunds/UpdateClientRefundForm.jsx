...
const UpdateClientRefundForm = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateClientRefund(refund.client_refunds_id || refund.refunds_id || refund.id, {
        client_id: formData.client_id,
        safe_id: formData.safe_id,
        method_id: formData.payment_method_id,
        amount: formData.amount,
        date: formData.refund_date
          ? formData.refund_date.split("T")[0]
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                className="flex-1 bg-[#8B5FD6] text-white py-3 px-4 rounded-md hover:bg-[#7A52C2] focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
