  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <div
        ...
        className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm cursor-pointer bg-white hover:border-gray-400 focus-within:ring-2 focus-within:ring-[#8B5FD6] focus-within:border-[#8B5FD6]"
      >
          ...
          <div className="p-4 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] focus:border-[#8B5FD6] text-sm"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 px-3 py-2 bg-[#8B5FD6] text-white text-sm rounded-lg hover:bg-[#7A52C2] focus:outline-none focus:ring-2 focus:ring-[#8B5FD6]"
              >
                تطبيق
              </button>
              <button
    ...
    () => [
      {
        ...
        render: (it) => {
          ...
          return (
            <span className="inline-flex items-center justify-center px-3 py-1 text-xs font-semibold rounded-full bg-[#EDE7FF] text-[#7A52C2]">
              {value}
            </span>
          );
        },
      ...
      },
      {
        ...
        render: (it) => {
          ...
          const tones = {
            ...
            Approved: "bg-[#EDE7FF] text-[#7A52C2]",
  ...
  const renderContent = () => {
    ...
    return (
      <>
        ...
        <CustomPageHeader
          title="مرتجعات البيع"
          icon={<ArrowPathIcon className="w-6 h-6 text-[#1A0F35]" />}
