            ...
            <>
                      ...
                      {formData.return_items.map((item, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-3 py-3 text-center">
                              <span className="inline-block bg-[#f5f3ff] text-[#7A52C2] text-xs font-medium px-2 py-0.5 rounded-full whitespace-nowrap">
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2 text-sm">
                  ...
                  {Number(totals.tax) > 0 && (
                    <div className="flex justify-between items-center text-[#8B5FD6]">
                      <span>الضريبة</span>
                      <span className="font-medium">
