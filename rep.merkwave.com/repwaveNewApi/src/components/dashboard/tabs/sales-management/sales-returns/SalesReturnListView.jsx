      ...
      <div className="bg-gradient-to-r from-[#f5f3ff] to-[#E8DFFF] px-6 py-4 border-b border-gray-300">
        <div className="flex items-center justify-between">
          <div className="text-sm text-gray-800">
            إجمالي المرتجعات:
            <span className="font-bold text-[#8B5FD6] ml-1">{returns.length}</span>
          </div>
          {searchTerm && (
                ...
                <td className="px-4 py-4 whitespace-nowrap">
                  <div className="flex items-center justify-center space-x-2 space-x-reverse">
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B5FD6] transition-colors"
                      title="عرض التفاصيل"
                    >
                    ...
                    {(returnItem.returns_status !== 'Processed' && returnItem.status !== 'Processed') && (
                      <button
                        ...
                        className="inline-flex items-center px-3 py-1.5 border border-transparent shadow-sm text-xs font-medium rounded-md text-white bg-[#8B5FD6] hover:bg-[#7A52C2] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B5FD6] transition-colors"
                        title="تعديل"
                      >
