  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <div
        ...
        className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm cursor-pointer bg-white hover:border-gray-400 focus-within:ring-2 focus-within:ring-[#8B5FD6] focus-within:border-[#8B5FD6]"
      >
          ...
          <div className="p-4 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] focus:border-[#8B5FD6] text-sm"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 px-3 py-2 bg-[#8B5FD6] text-white text-sm rounded-md hover:bg-[#7A52C2] focus:outline-none focus:ring-2 focus:ring-[#8B5FD6]"
              >
                تطبيق
              </button>
              <button
        ...
        <table className="min-w-full divide-y divide-gray-200 text-sm">
          ...
          <tbody className="bg-white divide-y divide-gray-100">
            {payments.map((item, idx) => (
              <tr
                key={item.client_payments_id || item.id || idx}
...
export default function ClientPaymentsTab() {
  ...
  const loadPayments = useCallback(async () => {
    ...
    try {
      ...
      setGlobalMessage({
        type: "error",
        message: "فشل في تحميل مدفوعات العملاء.",
      });
    } finally {
      setLoading(false);
    }
      ...
      list = list.filter(
        (i) =>
          (i.client_name || i.clients_company_name || "")
            .toLowerCase()
            .includes(term) ||
          (i.client_payments_notes || i.notes || "")
            .toLowerCase()
            .includes(term) ||
  ...
  const confirmDelete = async () => {
    try {
      await deleteClientPayment(
        paymentToDelete.client_payments_id || paymentToDelete.id,
      );
      ...
      <>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0">
          ...
          <div className="relative flex-grow mx-4">
            <input
              ...
              placeholder="ابحث عن مدفوعات العملاء..."
              className="w-full pl-4 pr-10 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] focus:border-[#8B5FD6]"
              dir="rtl"
            />
            {searchTerm && (
              <button
          ...
          <div className="flex-none">
            <button
              onClick={handleAdd}
              className="bg-[#8B5FD6] hover:bg-[#7A52C2] text-white font-bold py-2 px-4 rounded-md shadow-md flex items-center gap-2"
            >
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 mb-6">
          <h4 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2 border-b pb-2">
            <FunnelIcon className="h-5 w-5 text-[#8B5FD6]" />
            خيارات التصفية
          </h4>
          ...
          <div className="flex items-center gap-3 mt-4">
            <button
              ...
              className="px-4 py-2 bg-[#8B5FD6] text-white text-sm rounded-md hover:bg-[#7A52C2]"
            >
              تطبيق التصفية
            </button>
            <button
  ...
  return (
    <div className="p-4" dir="rtl">
      ...
      {currentView === "edit" && selectedPayment && (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-auto bg-black/40 backdrop-blur-sm p-4">
