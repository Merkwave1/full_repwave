...
const UpdateClientPaymentForm = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateClientPayment(payment.client_payments_id || payment.payments_id || payment.id, {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                className="flex-1 bg-[#8B5FD6] text-white py-1 md:py-3 px-4 rounded-md hover:bg-[#7A52C2] focus:outline-none focus:ring-2 focus:ring-[#8B5FD6] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
