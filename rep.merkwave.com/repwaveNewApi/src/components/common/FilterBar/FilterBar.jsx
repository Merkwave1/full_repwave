    ...
    <div className="relative w-full" ref={dropdownRef} dir="rtl">
      <div
        ...
        className="
          ...
          hover:bg-white
          focus-within:border-[#C4A8F0]
          focus-within:ring-4 focus-within:ring-[#C4A8F0]/25
          cursor-pointer
        "
      >
          ...
          <div className="p-4 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-gray-50 border border-transparent focus:bg-white focus:ring-2 focus:ring-[#C4A8F0]/25 focus:border-[#C4A8F0] text-sm"
              />
            </div>
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 px-3 py-2 rounded-lg bg-[#1A0F35] text-white text-sm hover:bg-[#111827]"
              >
                تطبيق
              </button>
...
export default function FilterBar({
  ...
  return (
    ...
    >
      <div className="absolute inset-x-0 top-0 h-1 bg-[#C4A8F0]" />

      <div className="flex flex-col md:flex-row mb-4">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1A0F35] text-white text-sm font-semibold shadow-sm">
          <FunnelIcon className="h-4 w-4 text-[#C4A8F0]" />
          {title}
        </div>
      </div>
                ...
                <div className="flex items-center gap-2">
                  {showSearchApply && (
                    <button
                      ...
                      className="px-4 py-1.5 rounded-lg bg-[#1A0F35] text-white text-sm hover:bg-[#111827] transition shadow-sm"
                    >
                      {applyLabel}
                    </button>
                  )}
