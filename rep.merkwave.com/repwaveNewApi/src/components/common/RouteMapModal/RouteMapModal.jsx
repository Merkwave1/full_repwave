    ...
    >
          {/* Route Statistics - 4 Cards */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              {/* Start Time */}
              <div className="bg-green-50 rounded-lg p-4 border border-[#C4A8F0]">
              ...
              {/* Duration */}
              <div className="bg-[#f5f3ff] rounded-lg p-4 border border-[#C4A8F0]">
                <div className="text-xs text-[#8B5FD6] mb-1">مدة التحرك</div>
            ...
            {/* Info */}
            <div className="mt-4 bg-[#f5f3ff] rounded-lg p-4">
              <p className="text-sm text-[#2D1B69]">
