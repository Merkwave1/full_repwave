...
return (
  <div
    className={`
      ...
      backdrop-blur-md
      bg-gradient-to-br from-[#C4A8F0]/25 via-white to-white
  ...
  >
    ...
    >
      ...
      <label className="text-xs sm:text-sm text-[#1A0F35]/70 font-medium whitespace-nowrap">
        عدد العناصر
      </label>
      ...
      <div className="relative shrink-0">
        <select
          ...
          className="
            ...
            shadow-sm
            focus:outline-none
            focus:ring-2 focus:ring-[#C4A8F0]
            hover:border-[#C4A8F0]
            transition
          "
        >
        ...
        <div className="pointer-events-none absolute inset-y-0 right-3 flex items-center text-[#1A0F35]/70">
      ...
      ">
        ...
        {(isNavigating || loading) && (
          <div className="mx-2 shrink-0">
            <div className="animate-spin h-5 w-5 border-2 border-[#1A0F35] border-t-transparent rounded-full" />
          </div>
        )}
        ...
        <button
          ...
          className="p-2 sm:p-2.5 rounded-lg hover:bg-[#C4A8F0]/30 disabled:opacity-40 transition"
        >
        ...
        <span className="px-3 sm:px-4 py-1 text-xs sm:text-sm font-semibold text-[#1A0F35] whitespace-nowrap">
          {cur} / {tp}
        </span>
