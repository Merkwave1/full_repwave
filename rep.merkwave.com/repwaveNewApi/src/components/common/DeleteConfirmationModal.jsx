      ...
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow-xl max-w-sm w-full mx-2 sm:mx-4 max-h-[95vh] overflow-y-auto">
        ...
        <div className="flex justify-center space-x-4 space-x-reverse">
          <button
            ...
            onClick={onClose}
            className={`px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B5FD6] transition duration-150 ease-in-out ${deleteLoading ? "text-gray-400 cursor-not-allowed" : "text-gray-700 hover:bg-gray-50"}`}
          >
            إلغاء
          </button>
          <button
