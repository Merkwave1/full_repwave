  ...
  return (
    <Modal isOpen={isOpen} onClose={onCancel} title={title} size="small">
      ...
      <div className="mt-6 flex justify-end gap-3">
        ...
        <button
          onClick={onConfirm}
          className={`px-4 py-2 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 ${danger ? 'bg-red-600 hover:bg-red-700 focus:ring-red-500' : 'bg-[#02415A] hover:bg-[#7A52C2] focus:ring-[#8B5FD6]'}`}
        >
          {confirmText}
        </button>
      </div>
