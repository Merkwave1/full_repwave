  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4" dir="rtl">
      <div className="text-center bg-white p-8 rounded-lg shadow-md">
        <h1 className="text-6xl font-bold text-[#8B5FD6] mb-4">404</h1>
        ...
        <Link
          to="/"
          className="inline-block px-6 py-3 rounded-lg font-semibold text-white bg-[#8B5FD6] hover:bg-[#7A52C2] transition duration-200"
        >
