...
function DashboardPage() {
  const navLinkClasses = ({ isActive }) => `py-2 px-4 text-sm font-medium border-b-2 focus:outline-none transition-colors duration-200 ${isActive ? 'border-[#8B5FD6] text-[#8B5FD6]' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`;
