// lib/modules/safes/screens/add_expense_screen.dart
...
class AddExpenseScreen extends GetView<AddExpenseController> {
  ...
  Future<void> _confirmAndSubmit(BuildContext context) async {
    ...
    final buffer = StringBuffer('هل تريد تأكيد إضافة المصروف بقيمة $formattedAmount $currency');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(() => DropdownButtonFormField<int>(
                            ...
                            items: controller.expenseAccounts.map((account) {
                              return DropdownMenuItem<int>(
                                value: account.id,
                                child: Text(
