...
function AddClientForm({
          ...
          const normalized = parsed.map((c) => ({
            ...
            governorates: Array.isArray(c.governorates)
              ? c.governorates.map((g) => ({
                  id: String(
                    g.governorates_id ?? g.id ?? g.governoratesId ?? g.id ?? "",
                  ),
  ...
  const handleSubmit = (e) => {
    ...
    const isContactInfoMissing =
      !formData.clients_contact_name || !formData.clients_contact_phone_1;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                required
                className="block w-full px-5 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 hover:border-gray-400 bg-white"
              >
...
<div>
  ...
  <div className="relative">
    ...
    <div className="pointer-events-none absolute inset-y-0 left-20 flex items-center text-gray-500">
      <svg
        className="w-5 h-5"
        fill="none"
        stroke="currentColor"
