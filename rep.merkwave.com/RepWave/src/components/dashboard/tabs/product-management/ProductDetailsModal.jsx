...
export default function ProductDetailsModal({
  ...
  const srcUrl =
    product.products_image_url && product.products_image_url.startsWith("http")
    ...
    <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6 flex flex-col md:flex-row items-center md:items-start gap-6">
          <div className="flex-shrink-0">
            <img
              ...
              onError={(e) => {
                e.currentTarget.src =
                  "https://placehold.co/192x192/E2E8F0/64748B?text=Image+Error";
          ...
          <div className="flex-grow text-center md:text-right">
            ...
            <div className="mt-4 flex flex-wrap justify-center md:justify-end gap-3">
              <span
                className={`text-sm font-semibold px-3 py-1 rounded-full ${product.products_is_active ? "bg-blue-100 text-blue-800" : "bg-red-100 text-red-800"}`}
              >
      ...
      <div className="p-4 bg-gray-100 border-t border-gray-200 rounded-b-xl sticky bottom-0">
        <div className="flex justify-center">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-4 py-3 sm:px-6 sm:py-2.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-base sm:text-sm"
          >
            إغلاق
          </button>
        </div>
