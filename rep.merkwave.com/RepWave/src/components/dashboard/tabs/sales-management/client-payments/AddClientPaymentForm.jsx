...
const AddClientPaymentForm = ({
  ...
  const modal = (
    ...
    >
      ...
      >
        {/* ── Premium Header ── */}
        <div className="px-5 py-4 flex items-center justify-between bg-gradient-to-l from-emerald-600 to-green-500">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-white/70 hidden sm:block">
                أدخل بيانات التحصيل ثم اضغط حفظ
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-2.5 border-b border-gray-100 bg-gray-50">
              <UserCircleIcon className="h-4 w-4 text-emerald-500" />
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-3 pt-1 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full sm:flex-1 py-2.5 px-6 rounded-xl text-sm font-bold text-white bg-gradient-to-l from-emerald-600 to-green-500 hover:from-emerald-700 hover:to-green-600 transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
                ...
                <>
                  <CurrencyDollarIcon className="h-4 w-4" /> حفظ الدفعة
                </>
              )}
            </button>
          </div>
