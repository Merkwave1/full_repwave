        ...
        <div className="flex items-center justify-end space-x-4 rtl:space-x-reverse p-6 border-t border-gray-200 bg-gray-50 print:hidden">
          {onEdit && (
            <button
              ...
              className="px-4 py-2 text-white bg-emerald-600 border border-transparent rounded-md hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
            >
              تعديل
            </button>
          )}
